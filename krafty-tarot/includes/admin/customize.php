...
Class Customize {
  ...
  public function __construct() {
    add_action('customize_register', array(self::class, 'add_site'));
    add_action('customize_register', array(self::class, 'add_information'));
    add_action('customize_register', array(self::class, 'add_locations'));
    add_action('customize_register', array(self::class, 'add_social_media'));
  }
